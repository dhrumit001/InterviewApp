...
namespace App.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(AppMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[AppMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
